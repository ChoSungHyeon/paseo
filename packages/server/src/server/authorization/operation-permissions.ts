...
const INBOUND_PERMISSION = {
  ...
  "schedule.state.restore.request": "automation.manage",
  "schedule.state.transition.request": "automation.manage",
...
const OUTBOUND_PERMISSION = {
  ...
  "schedule.state.restore.response": "automation.manage",
  "schedule.state.transition.response": "automation.manage",
